...
const TableNameGameCtrlAccountHouse = "game_account_house"

type GameCtrlAccountHouse struct {
...
func (GameCtrlAccountHouse) TableName() string { return TableNameGameCtrlAccountHouse }
