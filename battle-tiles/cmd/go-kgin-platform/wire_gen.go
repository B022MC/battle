...
func wireApp(global *conf.Global, confServer *conf.Server, data *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	shopGroupUseCase := game2.NewShopGroupUseCase(shopGroupRepo, shopGroupMemberRepo, gameShopAdminRepo, gameMemberRepo, gameAccountRepo, gameAccountGroupRepo, logger)
