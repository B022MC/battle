...
func wireApp(global *conf.Global, confServer *conf.Server, data *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	basicRouter := router.NewBasicRouter(basicUserService, basicLoginService, basicMenuService, basicRoleService)
	...
	shopAdminUseCase := game2.NewShopAdminUseCase(gameShopAdminRepo, shopGroupRepo, basicUserRepo, logger)
	...
	shopApplicationService := game3.NewShopApplicationService(manager, userApplicationRepo, basicUserRepo, authRepo, gameShopAdminRepo)
	...
	battleRecordUseCase := game2.NewBattleRecordUseCase(battleRecordRepo, gameCtrlAccountRepo, gameCtrlAccountHouseRepo, gameAccountRepo, gameMemberRepo, logger)
	...
	shopGroupService := game3.NewShopGroupService(shopGroupUseCase, logger)
