...
func wireApp(global *conf.Global, confServer *conf.Server, data *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	basicLoginUseCase := basic2.NewBasicLoginUseCase(basicLoginRepo, global, authRepo, logger)
	...
	gameRouter := router.NewGameRouter(accountService, sessionService, fundsService, ctrlAccountService, shopAdminService, shopTableService, gameShopMemberService, gameStatsService, walletQueryService, shopApplicationService, gameGroupService, houseSettingsService, shopGroupAdminService, battleRecordService)
